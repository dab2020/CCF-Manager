...
def editdata(sale_data):
    ...
    room_length_label = ctk.CTkLabel(room_info_frame, text="Length (m)")
    ...
    delete_room_button.grid(row=2, column=4, padx=10, pady=5, sticky="ew")
    ...
    serv_type_combobox = ctk.CTkComboBox(item_info_frame, values=["Carpet","Vinyl","Laminate","Wood Flooring","Commerical Flooring",
                                                                  "Underlay", "Grippers",
    ...
    add_item_button = ctk.CTkButton(item_info_frame, text="Add item",
                                    command=lambda: add_item(tree, serv_type_combobox, qty_spinbox, desc_entry,
                                                             price_spinbox))
    add_item_button.grid(row=2, column=0, columnspan=1, padx=10, pady=5, sticky="ew")
    delete_room_button = ctk.CTkButton(item_info_frame, text="Delete Entry", command=lambda: delete_latest_item_entry())
    delete_room_button.grid(row=2, column=1, columnspan=1, padx=10, pady=5, sticky="ew")
